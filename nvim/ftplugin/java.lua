...
local bundles = {
  vim.fn.glob(
    home .. "/dotfiles/tools/nvim/java/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-*.jar"
  ),
}

vim.list_extend(bundles, vim.split(vim.fn.glob(home .. "/dotfiles/tools/nvim/java/vscode-java-test/server/*.jar"), "\n"))
...
keymap("n", "<leader>je", "<Cmd>lua require('jdtls').extract_constant()<CR>", opts)
keymap("v", "<leader>je", "<Esc><Cmd>lua require('jdtls').extract_constant(true)<CR>", opts)
keymap("n", "<leader>jt", "<Cmd>lua require'jdtls'.test_nearest_method()<CR>", opts)
keymap("n", "<leader>jc", "<Cmd>lua require'jdtls'.test_class()<CR>", opts)
